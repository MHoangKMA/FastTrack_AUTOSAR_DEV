    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <main role="main" class="col col-md-8 col-lg-8 mx-auto pt-3">
          ...
          <h4 id="single_test_results">Test Results</h4>
  ...
  <ul class="nav flex-column">
    ...
    <li>
      <a class="nav-link" href="#single_test_results">
        <span class="oi oi-list"></span>Test Results
      </a>
...
<div style="margin-bottom:50px;" class="card" id="total-test-summary">
  ...
  <div class="card-body">
    ...
    <div class="row">
      ...
      <div class="col-md-auto">
        <p class="font-weight-bold">Passed:</p>
        <p class="text-danger">{total_abs_success_count}</p>
      </div>
      <div class="col-md-auto">
  ...
  <div class="card-body">
    <div class="single-test-summary">
      ...
      <div class="row">
        ...
        <div class="col-sm-auto">
          <p class="font-weight-bold">Passed:</p>
          <p class="text-danger">{testsuite_abs_success_count}</p>
        </div>
        <div class="col-sm-auto">
          <p class="font-weight-bold">Fails:</p>
